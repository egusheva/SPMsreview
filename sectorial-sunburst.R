...
# Load dataset
data <- read.csv("/Users/egusheva/Library/Mobile Documents/com~apple~CloudDocs/Documents/Work/TU Delft/Publications/SPMs review/Graphs/Sunburst plot/Data for AR5 sectors.csv", header=TRUE, sep=";")
